...
function updateUI() {
    ...
    if (_user) {
        ...
        const _tierNames = {free:'FREE', plus:'PLUS', pro:'PRO'};
...
(function() {
    const messages = [
        ...
        { icon: '🤖', text: '<strong>Bybit integration</strong> coming Q3 2026 — copy-trade across multiple exchanges.', color: '#00c853' },
        { icon: '�', text: '<strong>OKX integration</strong> on the roadmap — expanded exchange support for signals & copy-trading.', color: '#00b4d8' },
        { icon: '�📱', text: '<strong>Mobile app</strong> (iOS & Android) in development — push alerts, live P&L, one-tap trading.', color: '#f4a236' },
        { icon: '✅', text: '<strong>Backtesting engine is LIVE</strong> — replay real Binance signal history. <strong>Free account included.</strong>', color: '#00c853' },
        { icon: '🧪', text: 'Want to see how the signals perform? <strong>Create a free account</strong> and run a backtest in under 60 seconds.', color: '#a855f7' },
        ...
        { icon: '👑', text: '<strong>Ultra Plan</strong> entering next phase — exclusive features, higher limits & priority execution in development.', color: '#f4a236' },
    ];
